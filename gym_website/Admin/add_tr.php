...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    <h2 style="color:black; font-family: Lucida Console; text-align: center; font-size:45px;"><b>Add  New  Trainers</b></h2>
    <br>
    <br>
    <form class="tr" action="" method="post">
        ...
        <input type="text" name="timing" class="form-control" placeholder="timing" required=""><br>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"INSERT INTO trainer VALUES ('$_POST[id_no]', '$_POST[first]', '$_POST[last]', 
        '$_POST[email]', '$_POST[timing]', '$_POST[status]', '$_POST[level]', '$_POST[department]') ;");
        ?>
