...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    <h2 style="color:black; font-family: Lucida Console; text-align: center; font-size:45px;"><b>Add Gym Members</b></h2>
    <br>
    <br>
    <form class="tr" action="" method="post">
        ...
        <input type="text" name="trainer" class="form-control" placeholder="Trainer Name" required=""><br>
        <input type="text" name="package" class="form-control" placeholder="Package" required=""><br>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        ...
        '$_POST[trainer]', '$_POST[package]', '$_POST[amount]' , '$_POST[payment_id]', '$_POST[payment_type]');");
        ?>
