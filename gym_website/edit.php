...
<html>
    ...
    <body style="background-color: #763c63bd;"><br><br>
            ...
            <?php
                $sql="SELECT * FROM gym_members WHERE username='$_SESSION[login_user]'";
    ...
    <?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql1="UPDATE gym_members SET photo='$photo', first='$first', last='$last', username='$username', password='$password',
